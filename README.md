...
- **Build:** universal macOS `.app` export. Combat engine covered by **143 headless tests**.
...
4. Run the tests headless: `godot --headless scenes/test_combat.tscn` (expect `143 passed`).
