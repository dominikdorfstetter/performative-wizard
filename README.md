...
- **Build:** universal macOS `.app` export. Combat engine covered by **139 headless tests**.
...
4. Run the tests headless: `godot --headless scenes/test_combat.tscn` (expect `139 passed`).
