...
---
**Original roadmap complete (2026-06-06).** Then the game's **USP** was found and built:
...
Feed. Roster now: **49 cards, 24 enemy types + 2 bosses, 3 wizards, 19 outfits, 14
artifacts. 191/191 tests.** Future ideas live in `DESIGN_REVIEW.md` / `REVIEW_2.md` / `USP.md`.
