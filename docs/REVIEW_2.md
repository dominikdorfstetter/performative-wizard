...
3 wizards, 17 outfits, 14 artifacts, 3 acts, ascension, 73 tests.**
...
2. **Localization: strings are well-placed for it.** Content text funnels through a
   ...
   covers the game. This pass adds DE/ES (see `LOCALIZATION.md`).
...
4. **Code health: good.** No TODO/FIXME debt; combat logic covered by 73 tests; UI is
